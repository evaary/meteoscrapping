...
class MeteocielHourlyTester(TestCase):
    ...
    RESULTATS = pd.DataFrame(
        [["2020-01-01 23:00:00", "8/8", 0.7, 7.2, 100, 7.2, 7.2,  5.4,  9, 12, 1028.8, 0.0],
         ...
         ["2020-01-01 21:00:00", "8/8", 1.5, 7.0, 100, 7.0, 7.0,  5.2,  9, 16, 1029.1, 0.6],
         ["2020-01-01 20:00:00", "8/8", 2.3, 6.9, 100, 6.9, 6.9,  4.9, 10, 15, 1029.4, 0.0],
         ["2020-01-01 19:00:00", "8/8", 1.1, 6.8, 100, 6.8, 6.8,  4.6, 11, 18, 1029.6, 0.0],
         ["2020-01-01 18:00:00", "8/8", 1.5, 6.8, 100, 6.8, 6.8,  4.6, 11, 17, 1029.5, 0.0],
         ["2020-01-01 17:00:00", "8/8", 1.0, 6.7, 100, 6.7, 6.7,  4.4, 11, 17, 1029.6, 0.0],
         ["2020-01-01 16:00:00", "8/8", 3.2, 6.8, 100, 6.8, 6.8,  4.4, 12, 19, 1029.6, 0.0],
         ["2020-01-01 15:00:00", "8/8", 1.1, 6.4, 100, 6.4, 6.4,  3.9, 12, 20, 1029.6, 0.0],
         ["2020-01-01 14:00:00", "8/8", 2.8, 5.9, 100, 5.9, 5.9,  3.1, 13, 19, 1029.9, 0.0],
         ["2020-01-01 13:00:00", "8/8", 3.0, 5.2, 100, 5.2, 5.2,  1.9, 15, 21, 1030.8, 0.0],
         ["2020-01-01 12:00:00", "8/8", 2.5, 4.6, 100, 4.6, 4.6,  1.4, 14, 22, 1031.6, 0.0],
         ["2020-01-01 11:00:00", "8/8", 1.3, 3.7, 100, 3.7, 3.7,  0.3, 14, 20, 1031.5, 0.0],
         ["2020-01-01 10:00:00", "8/8", 1.5, 3.0, 100, 3.0, 3.0, -0.6, 14, 20, 1031.6, 0.0],
         ["2020-01-01 09:00:00", "8/8", 0.8, 2.5, 100, 2.5, 2.5, -0.6, 11, 20, 1031.5, 0.0],
         ["2020-01-01 08:00:00", "9/8", 0.4, 2.3, 100, 2.3, 2.3, -0.8, 11, 16, 1031.0, 0.0],
         ["2020-01-01 07:00:00", "9/8", 0.4, 2.4, 100, 2.4, 2.4, -0.9, 12, 18, 1030.8, 0.0],
         ["2020-01-01 06:00:00", "8/8", 0.6, 2.5, 100, 2.5, 2.5, -0.4, 10, 14, 1031.0, 0.0],
         ["2020-01-01 05:00:00", "8/8", 0.5, 2.6, 100, 2.6, 2.6,  0.0,  9, 12, 1031.2, 0.0],
         ["2020-01-01 04:00:00", "8/8", 0.9, 2.5, 100, 2.5, 2.5,  0.2,  8, 12, 1031.4, 0.0],
         ["2020-01-01 03:00:00", "8/8", 0.7, 2.3, 100, 2.3, 2.3,  1.5,  4, 11, 1031.6, 0.0],
         ["2020-01-01 02:00:00", "9/8", 0.5, 2.1, 100, 2.1, 2.1,  0.4,  6, 10, 1031.7, 0.0],
