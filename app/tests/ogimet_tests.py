...
class OgimetHourlyTester(TestCase):
    ...
    RESULTATS = pd.DataFrame(
        [["2023-02-01 00:00:00", 6.7, 4.9, 88, np.NaN, np.NaN, "WSW", 10.8, 18.0, 18.0, 1017.3, 1028.5, -0.4,         "Tr/6h",    8.0, 8,    0.3, np.NaN, 15.0],
         ["2023-02-01 01:00:00", 6.5, 4.8, 89, np.NaN, np.NaN,  "SW", 10.8, 18.0, 18.0, 1017.0, 1028.2, -0.7,        "0.0/1h",    8.0, 8,    0.3, np.NaN, 14.0],
         ["2023-02-01 02:00:00", 6.1, 4.7, 91, np.NaN, np.NaN, "WSW",  7.2, 10.8, 18.0, 1017.4, 1028.6,  0.1,        "0.0/1h",    8.0, 8,    0.3, np.NaN, 11.0],
         ["2023-02-01 03:00:00", 6.6, 4.9, 89, np.NaN, np.NaN, "WSW",  7.2, 14.4, 14.4, 1017.2, 1028.4, -0.1,        "0.0/3h",    8.0, 8,    0.6, np.NaN, 18.0],
         ["2023-02-01 04:00:00", 7.3, 2.6, 72, np.NaN, np.NaN, "WNW", 18.0, 28.8, 28.8, 1017.4, 1028.6,  0.4,        "0.0/1h",    8.0, 8,    1.0, np.NaN, 28.0],
         ["2023-02-01 05:00:00", 6.9, 2.4, 73, np.NaN, np.NaN,   "W", 14.4, 21.6, 25.2, 1017.3, 1028.5, -0.1,        "0.0/1h",    7.0, 7,    1.0, np.NaN, 27.0],
         ["2023-02-01 06:00:00", 5.9, 2.2, 77,    7.6,    5.9,   "W", 10.8, 18.0, 18.0, 1017.8, 1029.0,  0.6, "Tr/24h_Tr/12h", np.NaN, 3, np.NaN,    1.6, 19.0],
         ["2023-02-01 07:00:00", 5.6, 2.2, 79, np.NaN, np.NaN, "WSW",  7.2, 10.8, 18.0, 1017.9, 1029.1,  0.5,        "0.0/1h",    6.0, 6,    1.0, np.NaN, 20.0],
         ["2023-02-01 08:00:00", 5.6, 2.2, 79, np.NaN, np.NaN,   "W",  7.2, 10.8, 14.4, 1018.7, 1029.9,  1.4,        "0.0/1h",    5.0, 5,    1.0, np.NaN, 20.0],
         ["2023-02-01 09:00:00", 7.2, 2.9, 74, np.NaN, np.NaN, "WSW", 10.8, 18.0, 18.0, 1018.3, 1029.5,  0.5,        "0.0/3h",    6.0, 6,    1.0, np.NaN, 20.0],
         ["2023-02-01 10:00:00", 7.7, 2.4, 69, np.NaN, np.NaN,   "W", 14.4, 28.8, 28.8, 1019.1, 1030.3,  1.2,        "0.0/1h",    7.0, 7,    1.0, np.NaN, 15.0],
         ["2023-02-01 11:00:00", 8.8, 2.4, 64, np.NaN, np.NaN,   "W", 21.6, 32.4, 32.4, 1018.9, 1030.0,  0.2,        "0.0/1h",    8.0, 8,    1.0, np.NaN, 21.0],
         ["2023-02-01 12:00:00", 9.5, 3.2, 65, np.NaN, np.NaN,   "W", 25.2, 39.6, 39.6, 1018.5, 1029.6,  0.2,        "0.0/6h",    7.0, 7,    0.6, np.NaN, 15.0],
         ["2023-02-01 13:00:00", 9.6, 2.2, 60, np.NaN, np.NaN,   "W", 25.2, 36.0, 36.0, 1018.0, 1029.1, -1.1,        "0.0/1h",    7.0, 7,    0.6, np.NaN, 19.0],
         ["2023-02-01 14:00:00", 9.2, 2.3, 62, np.NaN, np.NaN,   "W", 21.6, 32.4, 43.2, 1017.6, 1028.7, -1.3,        "0.0/1h",    7.0, 7,    1.0, np.NaN, 15.0],
         ["2023-02-01 15:00:00", 9.2, 2.3, 62, np.NaN, np.NaN,   "W", 21.6, 32.4, 36.0, 1017.5, 1028.6, -1.0,        "0.0/3h",    7.0, 7,    1.0, np.NaN, 15.0],
         ["2023-02-01 16:00:00", 8.9, 2.2, 63, np.NaN, np.NaN,   "W", 18.0, 32.4, 32.4, 1017.7, 1028.8, -0.3,        "0.0/1h",    6.0, 6,    1.0, np.NaN, 30.0],
         ["2023-02-01 17:00:00", 8.7, 2.0, 63, np.NaN, np.NaN,   "W", 10.8, 25.2, 25.2, 1018.1, 1029.2,  0.5,        "0.0/1h",    7.0, 7,    1.0, np.NaN, 15.0],
         ["2023-02-01 18:00:00", 8.4, 2.0, 64,   10.7,    5.5,   "W", 14.4, 21.6, 21.6, 1018.4, 1029.5,  0.9,       "0.0/12h",    7.0, 6,    1.0, np.NaN, 15.0],
         ["2023-02-01 19:00:00", 7.9, 2.1, 67, np.NaN, np.NaN, "WNW", 10.8, 18.0, 21.6, 1018.5, 1029.7,  0.8,        "0.0/1h",    7.0, 7,    1.5, np.NaN, 15.0],
         ["2023-02-01 20:00:00", 8.1, 2.1, 66, np.NaN, np.NaN, "WSW", 14.4, 21.6, 25.2, 1018.7, 1029.8,  0.6,        "0.0/1h",    7.0, 7,    1.5, np.NaN, 15.0],
         ["2023-02-01 21:00:00", 7.4, 2.9, 73, np.NaN, np.NaN,   "W", 10.8, 18.0, 21.6, 1018.9, 1030.1,  0.5,        "0.0/3h",    7.0, 7,    1.5, np.NaN, 15.0],
         ["2023-02-01 22:00:00", 6.9, 2.8, 75, np.NaN, np.NaN,   "W", 14.4, 21.6, 21.6, 1018.8, 1030.0,  0.3,        "0.0/1h",    7.0, 7,    1.5, np.NaN, 15.0],
         ["2023-02-01 23:00:00", 6.3, 3.1, 80, np.NaN, np.NaN, "WSW", 10.8, 18.0, 21.6, 1018.8, 1030.0,  0.1,        "0.0/1h",    7.0, 4,    1.5, np.NaN, 15.0]],

         columns=["date",
                  "t_°C", "td_°C",
                  "hr_%",
                  "tmax_°C", "tmin_°C",
                  "ddd", "ff_km/h", "gust_km/h", "gust_max_km/h",
